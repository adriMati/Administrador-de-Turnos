Public NotInheritable Class FormAcercaDe
    ...
    Private Sub FormAcercaDe_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.TextBoxDescription.Text = "Dicho Sistema Permite la Administración de Pacientes con sus fichas médicas como asi también la administración de turnos" + Environment.NewLine + "Contacto:" + Environment.NewLine + "Cel. 03447-15436621" + Environment.NewLine + "Email: informacionceni@gmail.com"
    End Sub
